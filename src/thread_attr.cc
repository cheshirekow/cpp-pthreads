...
template<>
int Access<Thread, DetachState>::get(Attr<Thread>& attr_in,
                                     DetachState& value) const {
  pthread_attr_t* attr = &(attr_in.m_data);
  int outVal;
...
template<>
int Access<Thread, InheritSched>::get(Attr<Thread>& attr_in,
                                      InheritSched& value) const {
  pthread_attr_t* attr = &(attr_in.m_data);
  int outVal;
...
template<>
int Access<Thread, SchedPolicy>::get(Attr<Thread>& attr_in,
                                     SchedPolicy& value) const {
  pthread_attr_t* attr = &(attr_in.m_data);
  int outVal;
...
template<>
int Access<Thread, GuardSize>::get(Attr<Thread>& attr_in,
                                   GuardSize& value) const {
  pthread_attr_t* attr = &(attr_in.m_data);
  size_t outVal;
...
template<>
int Access<Thread, StackSize>::get(Attr<Thread>& attr_in,
                                   StackSize& value) const {
  pthread_attr_t* attr = &(attr_in.m_data);
  size_t outVal;
